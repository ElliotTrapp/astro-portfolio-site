...
_Dark Mode_ is triggered by the little 'sunlight' icon:<ThemeButton/>in the page header. It is defined in the _components/common/ThemeButton.astro_, but the event is attached and the action defined in _components/common/BasicScripts.astro_ in the following snippet:
